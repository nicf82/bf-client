...
case class MarketChangeMessage(id: Option[Int] = None, ct: Option[MarketChangeMessage.Ct] = None, clk: Option[String] = None, heartbeatMs: Option[Long] = None, pt: Option[Long] = None, initialClk: Option[String] = None, mc: Option[_root_.scala.Vector[MarketChange]] = None, conflateMs: Option[Long] = None, segmentType: Option[MarketChangeMessage.SegmentType] = None, status: Option[Int] = None) extends ResponseMessage
object MarketChangeMessage {
  ...
  implicit val decodeMarketChangeMessage: _root_.io.circe.Decoder[MarketChangeMessage] = new _root_.io.circe.Decoder[MarketChangeMessage] { final def apply(c: _root_.io.circe.HCursor): _root_.io.circe.Decoder.Result[MarketChangeMessage] = for (v0 <- c.downField("id").as[Option[Int]]; v1 <- c.downField("ct").as[Option[MarketChangeMessage.Ct]]; v2 <- c.downField("clk").as[Option[String]]; v3 <- c.downField("heartbeatMs").as[Option[Long]]; v4 <- c.downField("pt").as[Option[Long]]; v5 <- c.downField("initialClk").as[Option[String]]; v6 <- c.downField("mc").as[Option[_root_.scala.Vector[MarketChange]]]; v7 <- c.downField("conflateMs").as[Option[Long]]; v8 <- c.downField("segmentType").as[Option[MarketChangeMessage.SegmentType]]; v9 <- c.downField("status").as[Option[Int]]) yield MarketChangeMessage(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) }
