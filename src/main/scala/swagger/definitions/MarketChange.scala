...
case class MarketChange(rc: Option[_root_.scala.Vector[RunnerChange]] = None, img: Option[Boolean] = None, tv: Option[Double] = None, con: Option[Boolean] = None, marketDefinition: Option[MarketDefinition] = None, id: Option[String] = None)
object MarketChange {
